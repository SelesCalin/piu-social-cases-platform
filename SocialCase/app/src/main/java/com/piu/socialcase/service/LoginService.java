...
public class LoginService {
    ...
    public Integer signUp(String username,String password, String confirmPass,String fullName, String email, String phone, String address,String dateOfBirth,String[] preferences,String ong){
        ...
        if(!password.equals(confirmPass))
            return -3;
        Volunteer volunteer= new Volunteer(username,password,email,phone,fullName,dateOfBirth,address,ong,preferences);
